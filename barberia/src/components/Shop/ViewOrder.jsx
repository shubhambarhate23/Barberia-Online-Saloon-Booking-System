...
const ViewOrder = () => {
    ...
    const shopno=localStorage.getItem("shopno")
    //console.log(shopno)
    useEffect(() => {
        init();
    }, [])
    ...
    const init = () => {
        const fetchData = async () => {
            const response = await RegisterService.getAllOrderBySr(shopno)
            try {
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 ">
              ...
              <li class="nav-item">
                <a class="nav-link  active" href='/ShopProfile'><p className='text-dark fw-bold'>Back</p></a>
              </li>
            </ul>
          </div>
        </div>
